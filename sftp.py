...
def generate_metadata(model, img):
    ...
    tags = model.generate_content(["Generate up to 40 keywords in English that are relevant to the image (each keyword must be one word, separated by commas).", img])
