...
def generate_metadata(model, img):
    caption = model.generate_content([
        "(Create a descriptive title in English up to 12 words long) the title include Subject, activity, context, setting, concept, Essence Capture, Relevant Elements, Emotion Emphasis, Context Detail, Descriptive Clarity. "
